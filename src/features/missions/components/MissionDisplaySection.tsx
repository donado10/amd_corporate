...
import useGetMissionFile from "../api/use-get-mission-file";
            ...
            left={[
              {
                ...
                value: formatDate(mission.em_birthday),
              },
              { label: "Nationalité", value: mission.em_nationality },
              { label: "Téléphone", value: mission.em_phonenumber },
              { label: "Contact d'urgence", value: mission.em_emergencynumber },
            ]}
            right={[
              { label: "Lieu de Naissance", value: mission.em_birthplace },
              { label: "Adresse", value: mission.em_address },
              { label: "Email", value: mission.em_email },
            ]}
          />
        </div>
